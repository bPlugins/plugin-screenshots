...
- Go to **Advance Custom HTML** in your WordPress dashboard
...
- Paste the shortcode in a post, page, widget, or block


**Gutenberg Block Support**

The plugin includes a custom block for use in the WordPress editor.
